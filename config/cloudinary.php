...
return [
    ...
    */
    ...
    'long_url_signature' => env('CLOUDINARY_LONG_URL_SIGNATURE', false),
    'proxy_url' => env('CLOUDINARY_PROXY_URL'),
    'use_account_config' => env('CLOUDINARY_USE_ACCOUNT_CONFIG', false),
];
